  ...
  <body>
    ...
    <main>
      ...
      while($row=$select->fetch()){
          echo "<div> <img src=".$row["zdjecie"]." alt=uwu> <div><p><a href='aktor.php?idek={$row['id_rezyser']}'>".$row['imie']." ".$row['nazwisko']."</a></p></div></div>"; //użyć tego do wypisywania aktorów itp. z bazy na stronę, img nazwy w bazie, a obrazy w folderze img
