...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      $select = $poloczenie1->getPolaczenie()->query("SELECT * FROM rezyserzy where id_rezyser={$_GET['idek']}");
      while($row=$select->fetch()){
          echo "<div class=dedykowany> <img src=".$row["zdjecie"]." alt='zdjecie rezysera'> <div><p>".$row['imie']." ".$row['nazwisko']."</p> <p>".$row['opis']."</p></div></div>"; 
